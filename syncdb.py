...
plfbgcsjb_comments = ['系统编号', '漂流浮标区站号', '观测日期时间', '接收日期时间', '接收日期', '接收时间', '北斗通讯指令标识', '数据报长度(字节)',
                      '收信方指挥机地址', '信息类别', '发信方终端地址', '发信时间', '发信时间时', '发信时间分', '电文位长度(比特)', '浮标类型',
                      '数据配置', '状态配置', '观测日期年', '观测日期月', '观测日期日', '观测时间时', '观测时间分', '经度(deg)', '经度半球',
                      '纬度(deg)', '纬度半球', '气温00(℃)','气温00质控', '气温10(℃)', '气温10质控', '气温20(℃)', '气温20质控', '气温30(℃)',
                      '气温30质控', '气温40(℃)','气温40质控', '气温50(℃)', '气温50质控', '气压00(hPa)', '气压00质控', '气压00趋势','气压30(hPa)',
                      '气压30质控', '气压30趋势', '海温00(℃)', '海温00质控', '海温15(℃)','海温15质控', '海温30(℃)', '海温30质控', '海温45(℃)',
                      '海温45质控', '海盐00(mS/cm)','海盐00质控', '海盐15(mS/cm)', '海盐15质控', '海盐30(mS/cm)', '海盐30质控', '海盐45(mS/cm)',
                      '海盐45质控', '风速00(m/s)', '风速00质控', '风速10(m/s)', '风速10质控', '风速20(m/s)','风速20质控', '风速30(m/s)', '风速30质控',
                      '风速40(m/s)', '风速40质控', '风速50(m/s)','风速50质控', '风向00(deg)', '风向00质控', '风向10(deg)', '风向10质控', '风向20(deg)',
                      '风向20质控', '风向30(deg)', '风向30质控', '风向40(deg)', '风向40质控', '风向50(deg)','风向50质控', '浸没状态(次数)', '主板温度(℃)',
                      '电源电压(V)', '运行状态', '定位和姿势状态', '姿态横滚角度','姿态俯仰角度', '姿态方位角度', '北斗通讯状态', '报文校验和', 'CRC标志',
                      '通讯标识校验和', '记录文件名称']

plfbjbxxb_comments = ['系统编号', '漂流浮标区站号', '最近观测时间', '序列号', '编号', '设备型号', '通讯类型', '释放时间', '释放海域', '最近观测点经度', '最近观测点纬度',
                      '观测场海拔高度', '气压传感器海拔高度', '观测方式', '质量控制标识', '文件更正标识', '是否测量气温',
                      '是否测量气压', '是否测量风向风速', '是否测量海温', '是否测量盐度', '记录最后更新时间']
